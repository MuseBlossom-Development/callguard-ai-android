...
object AppModule {
    ...
    fun provideCallGuardRetrofit(okHttpClient: OkHttpClient): Retrofit {
        return Retrofit.Builder()
            .baseUrl("https://1026a630-d34e-4090-b2db-894bcb256a4d.mock.pstmn.io/") // TODO: 실제 서버 URL로 변경
            .client(okHttpClient)
    ...
    fun provideDeepVoiceRetrofit(okHttpClient: OkHttpClient): Retrofit {
        return Retrofit.Builder()
            .baseUrl("https://1026a630-d34e-4090-b2db-894bcb256a4d.mock.pstmn.io/") // Updated base URL for deep voice service
            .client(okHttpClient)
            .addConverterFactory(GsonConverterFactory.create())
            .build()
    }
